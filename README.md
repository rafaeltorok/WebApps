...
- [Navigating the UI](./gpulist/README.md#navigating-the-ui)
  - [Main UI](./gpulist/README.md#main-ui)
    - [Displaying a graphics card data](./gpulist/README.md#displaying-a-graphics-card-data)
    - [Adding a new graphics card](./gpulist/README.md#adding-a-new-graphics-card)
    - [Using the search functionality](./gpulist/README.md#using-the-search-functionality)
    - [Using the index](./gpulist/README.md#using-the-index)
    - [Removing a graphics card from the list](./gpulist/README.md#removing-a-graphics-card-from-the-list)
  - [Alternative UI](./gpulist/README.md#alternative-ui)
    - [Displaying a graphics card data](./gpulist/README.md#displaying-a-graphics-card-data-1)
    - [Adding a new graphics card](./gpulist/README.md#adding-a-new-graphics-card-1)
    - [Using the search functionality](./gpulist/README.md#using-the-search-functionality-1)
    - [Removing a graphics card from the list](./gpulist/README.md#removing-a-graphics-card-from-the-list-1)
- [Performing CRUD operations on graphics cards through the backend server](./gpulist/README.md#performing-crud-operations-on-graphics-cards-through-the-backend-server)
- [Running the web app with Docker](./gpulist/README.md#running-the-web-app-with-docker)
- [E2E testing](./gpulist/README.md#e2e-testing)
  - [Manual testing](./gpulist/README.md#manual-testing)
  - [Testing through Docker containers](./gpulist/README.md#testing-through-docker-containers)
- [Explaning the backend server web app structure](./gpulist/README.md#explaning-the-backend-server-web-app-structure)
